...
public class AllPackageFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_all_package, null);
        lv_all = view.findViewById(R.id.lv_add_order);
        ...
        OkHttpUtils.post()
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        Gson gson = new Gson();
                        bodyList = gson.fromJson(response, new TypeToken<List<DirOrder.Body>>() {}.getType());
